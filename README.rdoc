...
$ gem install gem_conflict_plugin
$ gem install gem_conflict_plugin # install it twice so that by the time you install it the second time, its install hook will run and warn you of any conflicts.  Any gem install after this point will also warn you.
